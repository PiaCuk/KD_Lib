...
if __name__ == "__main__":
    ...
    for algo in ["tfkd"]: # "tfkd", "vanilla"
        for weight in [0.2, 0.5, 0.9]:
            params = {
                "algo": algo,
                "runs": 5,
                "epochs": 100,
                "batch_size": 1024,
                "save_path": f"/data_b/9cuk/kd_lib/replicate1/oversample{weight}/",
                "loss_fn": CustomKLDivLoss(apply_softmax=algo != "dml_e"), # SoftKLDivLoss(temp=10.0)
                "lr": 0.005,
                "distil_weight": 1.0,
